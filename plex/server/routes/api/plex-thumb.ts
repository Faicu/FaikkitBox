...
// Proxy pentru postere Plex — fișier nou, independent de
// /opt/faikkitbox/server/routes/api/plex-thumb.ts (nu se atinge). Necesar
// pentru fundalul cu thumbnail-uri de pe paginile publice (/, /login,
// /register), fără să expunem PLEX_TOKEN către browser.
