...
import { subscribeUserPush, unsubscribeUserPush, getVapidPublicKey } from "../lib/push";
...
export function usePushNotifications() {
  ...
  const doSubscribe = useServerFn(subscribeUserPush);
  const doUnsubscribe = useServerFn(unsubscribeUserPush);
  ...
  async function subscribe() {
    ...
    try {
      ...
      console.error("[plex-push] Eroare la abonare:", msg, e);
      setError(msg);
