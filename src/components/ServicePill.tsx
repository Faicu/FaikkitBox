...
export function ServicePill({ status, label }: Props) {
  const map = {
    ok: { bg: "bg-emerald-500/15 text-emerald-400 ring-1 ring-emerald-500/25", Icon: CircleCheck, text: label ?? "Online" },
    error: { bg: "bg-red-500/15 text-red-400 ring-1 ring-red-500/25", Icon: CircleAlert, text: label ?? "Offline" },
