...
export const PLUGINS: PluginInfo[] = [
  {
    ...
    cadence:
      "la 3h per serial · la 12h per film (prima, la 1 min) · detalii seriale și filme la 12h · verificat din 10 în 10 min",
    details:
      "Face patru lucruri la fiecare tic, fiecare cu ritmul lui.\n\n1. Descărcarea episoadelor noi, la 3h per serial urmărit: compară ce s-a difuzat (TMDB, inclusiv episodul lansat azi) cu ce ai deja în bibliotecă și aduce diferența de pe Filelist, strict după IMDb ID — întrebând mereu Filelist direct, fără cache. Nu ține minte ce a văzut ultima dată: întreabă de fiecare dată realitatea, deci se poate relua oricând, se repară singur după un restart și nu poate descărca de două ori. După fiecare descărcare, poziția de start avansează peste episoadele aduse (fără să sară vreunul lipsă), ca un episod văzut și șters din Bibliotecă să nu revină. Dacă ai ales o calitate de rezervă, ea se ia doar când principala lipsește la două verificări, la cel puțin 3 ore distanță.\n\n2. Detaliile serialelor, la 12h — inclusiv ale celor neurmărite: status (încheiat / în producție), titlul românesc și cel original, anul, descrierea, genurile, posterul și următorul episod anunțat. Odată cu serialul, și toate episoadele lui: numele, descrierea, cadrul din episod și posterul sezonului. Totul e cerut în română la fiecare trecere; ce TMDB n-are încă în română rămâne în engleză până apare traducerea. Statusul contează și la serialele neurmărite: decide dacă ți se oferă butonul de urmărire.\n\n3. Detaliile filmelor, la 12h: titlul românesc și cel original, anul, descrierea, genurile și posterul — după aceeași regulă, în română, cu engleza ca rezervă.\n\n4. Filmele așteptate, la 12h fiecare: filme pe care le-ai cerut, dar care încă nu existau pe Filelist la calitatea vrută. Cadență mai lentă decât la seriale fiindcă un film poate întârzia luni de zile, iar înainte de data lansării nici nu se caută — n-ar avea ce găsi. Prima verificare face excepție: vine la un minut după adăugare, pe o buclă proprie de 30s. Calitatea de rezervă funcționează ca la seriale. Spre deosebire de seriale, urmărirea unui film se stinge singură la prima descărcare reușită.",
