...
import { Film, Tv, Music, Image as ImageIcon, User, Trophy, ChevronRight, History, Flame, CheckCircle2, XCircle, HelpCircle } from "lucide-react";
...
import { plexQuery, showStatusQuery } from "@/lib/queries";
import { formatMs } from "@/lib/format";
import type { PlexHistoryEntry, ShowStatusData } from "@/lib/services.functions";
...
function PlexPage() {
  ...
  const { data: showData } = useQuery(showStatusQuery);
  ...
  return (
    ...
    >
      {showData?.status === "ok" && <ShowStatusCard data={showData} />}
